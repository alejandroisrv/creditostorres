          ...
          <div class="box-body">
            <div class="form-row">
              ...
              <div class="form-group col-md-12">
                <label>Productos <i class="fa fa-plus mx-2" @click="addCuadro"></i></label>
                <table class="table col-md-12 p-0" id="tabla-productos">
                </table>
              </div>
            </div>
  ...
  methods: {
    ...
    addCuadro(){
        let cuadro="<tr class='p'>";
           cuadro+="<td class='col-md-6 py-2'> <select class='form-control' name='productos[]'><option>Selecciona producto</option>"
           ...
           cuadro+="</select></td>" 
           cuadro+="<td class='col-md-6 py-2'><input type='text' class='form-control' name='cantidad' placeholder='cantidad'></td></tr>"        
